...
ALTER TABLE [Ingredients] ADD [IngredientCategoryId] int NOT NULL DEFAULT 0;
GO

CREATE INDEX [IX_Ingredients_IngredientCategoryId] ON [Ingredients] ([IngredientCategoryId]);
GO

ALTER TABLE [Ingredients] ADD CONSTRAINT [FK_Ingredients_IngredientCategories_IngredientCategoryId] FOREIGN KEY ([IngredientCategoryId]) REFERENCES [IngredientCategories] ([Id]) ON DELETE CASCADE;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20221005155121_Require ingredient categories for ingredients', N'6.0.9');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20221005155707_Remove ingredient recipe foreign key', N'6.0.9');
GO
